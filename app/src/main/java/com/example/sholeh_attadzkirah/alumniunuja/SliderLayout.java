...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * InfiniteViewPager adapter_berita.
     */
    ...
    public int getCurrentPosition(){
        ...
        if(getRealAdapter() == null)
            throw new IllegalStateException("You did not set a slider adapter_berita");
    ...
    public void removeAllSliders(){
        if(getRealAdapter()!=null){
            ...
            //bug: when remove adapter_berita's all the sliders.some caching slider still alive.
    ...
    public void setCurrentPosition(int position, boolean smooth) {
        if (getRealAdapter() == null)
            throw new IllegalStateException("You did not set a slider adapternya");
