...
//                kosong();
    ...
    public void keluar(){
        AlertDialog.Builder build = new AlertDialog.Builder(Add.this);
        build.setMessage("Apakah Anda yakin ingin membatalkan tambah data alumni ? ");
...
//                            spinkec.setAdapter(adap);
                            adapterspinner = new adapterspinner(Add.this, R.layout.support_simple_spinner_dropdown_item);
...
//                        spindesa.setAdapter(adap);
                        ...
                        Toast.makeText(Add.this, "Data Belum Ada", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Add.this, "Eror Cari " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        if (selectedImageUri != null) {
            try {
                ...
                if (selectedImagePath != null) {
                    ...
                    Toast.makeText(Add.this, "Unknown path",
                ...
                Toast.makeText(Add.this, "Internal error",
                        Toast.LENGTH_LONG).show();
...
//                            Toast.makeText(IsiData.this, "Username sudah ada yang pakai.
                            Toast.makeText(Add.this, "Username atau Nomor Telepon Akun Anda Sudah Terdaftar", Toast.LENGTH_SHORT).show();
                            progres.dismiss();


                        }else{
                            progres.dismiss();
                            Toast.makeText(Add.this, "Berhasil", Toast.LENGTH_SHORT).show();
                            kosong();
...
//                        Toast.makeText(Add.this, "Tidak terhubung ke server", Toast.LENGTH_SHORT).show();
                        Toast.makeText(Add.this, "Pilih foto usaha terlebih dahulu", Toast.LENGTH_LONG).show();
//                        Toast.makeText(IsiData.this,"D"+ error, Toast.LENGTH_LONG).show();
    ...
    private boolean validasi() {
        ...
        if (snoktp_.isEmpty() || snoktp_.length() < 16) {
            ...
            Toast.makeText(Add.this, "nik minimal 16 digit", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
        ...
        if (snama_.isEmpty() || snama_.length() < 3) {
            ...
            Toast.makeText(Add.this, "nama minimal 3 digit", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
        ...
        if (salamat_.isEmpty() || salamat_.length() < 3) {
            ...
            Toast.makeText(Add.this, "alamat minimal 3 digit", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
        ...
        if (stelepon_.isEmpty() || stelepon_.length() < 8) {
            ...
            Toast.makeText(Add.this, "nomor telepon minimal 8 digit", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
            ed_hp.setError(null);
        }
        ...
        if (stahunmondok_.isEmpty() || stahunmondok_.length() < 4) {
            ...
            Toast.makeText(Add.this, "tahun mondok  minimal 4 digit", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
        ...
        if (stahunkeluar_.isEmpty() || stahunkeluar_.length() < 4 ) {
            ...
            Toast.makeText(Add.this, "tahun keluar minimal 4 digit", Toast.LENGTH_SHORT).show();
        ...
        if (spekerjaan_.isEmpty() || spekerjaan_.length() < 2) {
            ...
            Toast.makeText(Add.this, "pekerjaan  minimal 2 digit", Toast.LENGTH_SHORT).show();
        ...
        if (sbidangusaha_.isEmpty() || sbidangusaha_.length() < 2) {
            ...
            Toast.makeText(Add.this, "bidang usaha  minimal 2 digit", Toast.LENGTH_SHORT).show();
        ...
        if (semail_.isEmpty() || !android.util.Patterns.EMAIL_ADDRESS.matcher(semail_).matches()) {
            ...
            Toast.makeText(Add.this, "Email tidak valid", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
        ...
        if (susername_.isEmpty() || susername_.length() < 3 ) {
            ...
            Toast.makeText(Add.this, "username minimal 3 digit", Toast.LENGTH_SHORT).show();
            valid = false;
        } else {
        ...
        if (spass_.isEmpty() || spass_.length() < 3) {
            ...
            Toast.makeText(Add.this, "password minimal 3 digit", Toast.LENGTH_SHORT).show();
...
//        rb_Aktif.setEnabled(false);
        ...
        ed_pendidikan.setText("");
        ed_NamaUsaha.setText("");
