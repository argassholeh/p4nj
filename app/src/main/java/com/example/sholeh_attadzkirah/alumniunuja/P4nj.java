...
public class P4nj extends AppCompatActivity implements BaseSliderView.OnSliderClickListener{
    ListView listView;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p4nj);
        toolBarisi =  findViewById(R.id.toolbar);
        toolBarisi.setTitle("");
        setSupportActionBar(toolBarisi);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        mDemoSlider = findViewById(R.id.sliderp4nj);
...
//      mDemoSlider.addOnPageChangeListener(this);
        ...
        listView = findViewById(R.id.listviewP4nj);
        ArrayAdapter<String> mAdapter = new ArrayAdapter<String>(P4nj.this,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                if (position == 0) {
                    intent = new Intent(P4nj.this, VisiMisi.class);
                    intent.putExtra("lembaga", "2");
                    startActivity(intent);
                } else if (position == 1) {
                    intent = new Intent(P4nj.this, Kepengurusan.class);
                    intent.putExtra("Pengurus", "2");
                    startActivity(intent);
                }
            }
        });
        listView.setAdapter(mAdapter);
        expandableListView = findViewById(R.id.expanlist_p4nj);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (childPosition == 0) {
                    intent = new Intent(P4nj.this, BeritaActivity.class);
                    intent.putExtra("id_lembaga_alumni", "2");
                        ...
                        if(response.contains("1")) {
                            try {
                                ...
                                for (int i = 0; i < result.length(); i++) {
                                    ...
                                    TextSliderView textSliderView = new TextSliderView(P4nj.this);
                                    // initialize a SliderLayout
                                    textSliderView
                                            .description(judul)
                                            .image(foto)
